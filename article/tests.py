...
class TestContentAPI(TestCase):
    def setUp(self):
        self.articles_list = get_articles_via_content_api()


    def test_get_homepage_article(self):
        homepage_article = get_homepage_article(self.articles_list)
    ...
    def test_get_article_by_uuid(self):
        homepage_article_uuid = "a7acd8c8-c5ce-11e7-9fa6-0050569d4be0"
        homepage_article = get_article_by_uuid(self.articles_list,homepage_article_uuid)
        ...
        test_article_1 = get_article_by_uuid(self.articles_list,test_article_1_uuid)
        ...
        test_article_2 = get_article_by_uuid(self.articles_list,test_article_2_uuid)
    ...
    def test_get_random_articles(self):
        count  = 3
        homepage_article_uuid = "a7acd8c8-c5ce-11e7-9fa6-0050569d4be0"
        random_articles = get_random_articles(self.articles_list,count)
